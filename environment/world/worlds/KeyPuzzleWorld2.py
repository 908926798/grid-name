...
class World( BaseWorld ):
    ...
    def _reset( self ):
        ...
        self.grids[0][3].addContent( Key() )
        self.grids[2][4].addContent( Key() )
        self.grids[6][7].addContent( Key() )
        self.grids[3][2].addContent( Key() )
        self.grids[7][4].addContent( Key() )
        self.grids[4][8].addContent( Door() )
        # agent
        x, y = self.agent.pos = (4,0)
